...
CREATE TABLE `stocks` (
  ...
  `上個交易日` varchar(45) DEFAULT NULL,
  `上次收盤價` double DEFAULT NULL,
  `下個交易日` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `stocks` VALUES (1,'2330','台G電',NULL,NULL,NULL),(2,'00940','元太彎韭菜',NULL,NULL,NULL),(3,'0056','元太高股息',NULL,NULL,NULL);
