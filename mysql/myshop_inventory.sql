...
CREATE TABLE `inventory` (
  ...
  `股數` varchar(45) DEFAULT NULL,
  `市價` varchar(45) DEFAULT NULL,
  `市值` varchar(45) DEFAULT NULL,
  `成本` varchar(45) DEFAULT NULL,
  `預估損益` varchar(45) DEFAULT NULL,
  `成交均價` varchar(45) DEFAULT NULL,
  `報酬率` varchar(45) DEFAULT NULL,
